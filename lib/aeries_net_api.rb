...
require 'aeries_net_api/models/gradebook_student'
require 'aeries_net_api/models/assignment'
require 'aeries_net_api/models/assignment_category'
require 'aeries_net_api/models/assignment_score'
require 'aeries_net_api/models/assignment_standard'
require 'aeries_net_api/models/assignment_standard_score'
