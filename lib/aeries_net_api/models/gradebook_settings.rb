  ...
  module Models
    ...
    class GradebookSettings < AeriesNetApi::Models::BaseModel
      ...
      @@aeries_attributes_list= %w{GradebookNumber CountCompletedNow DoingWeight ApplyRangeToStudent ShowLo ShowMinDate
        ShowHi ShowMaxDate FilterAssignmentsBy CountLo CountHi CountMinDate CountMaxDate ShowFinalMark
        DoingFormativeSummativeWeight FormativePercentage SummativePercentage DoingRubric DoingMinMaxAssignmentValues
        MinAssignmentValue MaxAssignmentValue}
      ...
      def parse(aeries_data, aeries_attributes_list, setters_list)
        super
        self.show_min_date=DateTime.parse(self.show_min_date) unless self.show_min_date.nil?
        self.show_max_date=DateTime.parse(self.show_max_date) unless self.show_max_date.nil?
        self.count_min_date = DateTime.parse(self.count_min_date) unless self.count_min_date.nil?
        self.count_max_date = DateTime.parse(self.count_max_date) unless self.count_max_date.nil?
      end
