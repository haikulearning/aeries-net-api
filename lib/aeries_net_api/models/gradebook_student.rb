  ...
  module Models
    ...
    class GradebookStudent < AeriesNetApi::Models::BaseModel
      ...
      @@aeries_attributes_list= %w{PermanentID SchoolCode StudentNumber InactiveTag StartDate EndDate LowAssignmentNumber
        HighAssignmentNumber CurrentPercentage CurrentMark CustomSortOrder StudentLastName StudentFirstName
        StudentMiddleName StudentGradeLevel StudentSex CurrentTerm}
