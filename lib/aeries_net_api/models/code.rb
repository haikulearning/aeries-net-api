module AeriesNetApi
  module Models
    ...
    # Class to represent Code information extracted from Aeries site.
    class Code < AeriesNetApi::Models::BaseModel

      # List of attributes to be extracted from Aeries site.
      @@aeries_attributes_list= %w{Table Field Code Description Category SortOrder Status}
