  ...
  module Models
    ...
    class Course < AeriesNetApi::Models::BaseModel
      ...
      @@aeries_attributes_list= %w{ID Title LongDescription Notes ContentDescription NonAcademicOrHonorsCode
        SubjectArea1Code SubjectArea2Code SubjectArea3Code DepartmentCode StateCourseCode CSFCourseList
        CollegePrepIndicatorCode CreditDefault CreditMax TermTypeCode LowGrade HighGrade CSU_SubjectAreaCode
        CSU_Rule_CanBeAnElective CSU_Rule_HonorsCode CSU_Rule_ValidationLevelCode UC_SubjectAreaCode
        UC_Rule_CanBeAnElective UC_Rule_HonorsCode UC_Rule_ValidationLevelCode TeacherAideIndicator
