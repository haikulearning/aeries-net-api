  ...
  module Models
    ...
    class GPA < AeriesNetApi::Models::BaseModel
      ...
      @@aeries_attributes_list = %w(PermanentID SchoolCode ClassRank ClassSize ClassRank1012 GPA_CumulativeAcademic
                                    GPA_CumulativeTotal GPA_CumulativeAcademic1012 GPA_CumulativeAcademicNonWeighted
                                    GPA_CumulativeTotalNonWeighted GPA_CumulativeAcademic1012NonWeighted
                                    GradePointsCumulative GPA_UC_Preliminary GPA_CSU_Preliminary
                                    GPA_CumulativeCitizenship GPA_GradeReportingCitizenship CreditsAttempted
                                    CreditsCompleted GPA_GradeReportingAcademic GPA_GradeReportingTotal
                                    GPA_GradeReportingAcademicNonWeighted GPA_GradeReportingTotalNonWeighted
                                    GradeReportingClassRank GradeReportingClassSize GradeReportingCreditsAttempted
