  ...
  module Models
    ...
    class StudentProgram < AeriesNetApi::Models::BaseModel
      ...
      def parse(aeries_data, aeries_attributes_list, setters_list)
        super
        self.eligibility_start_date = DateTime.parse(eligibility_start_date) unless eligibility_start_date.nil?
        self.eligibility_end_date = DateTime.parse(eligibility_end_date) unless eligibility_end_date.nil?
        self.participation_start_date = DateTime.parse(participation_start_date) unless participation_start_date.nil?
        self.participation_end_date = DateTime.parse(participation_end_date) unless participation_end_date.nil?
      end
    end
  end
end
