...
describe AeriesNetApi::Models::GradebookSection do

 let(:test_class) {AeriesNetApi::Models::GradebookSection}

  context 'methods' do
    it 'should create an empty instance of AeriesNetApi::Models::GradebookSection' do
