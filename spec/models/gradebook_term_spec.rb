...
describe AeriesNetApi::Models::GradebookTerm do

 let(:test_class) {AeriesNetApi::Models::GradebookTerm}

  context 'methods' do
    it 'should create an empty instance of AeriesNetApi::Models::GradebookTerm' do
