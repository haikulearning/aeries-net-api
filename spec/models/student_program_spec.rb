...
describe AeriesNetApi::Models::StudentProgram do
  let(:test_class) { AeriesNetApi::Models::StudentProgram }

  context 'methods' do
    it 'should create an empty instance of AeriesNetApi::Models::StudentProgram' do
