...
describe AeriesNetApi::Models::AssignmentCategory do

 let(:test_class) {AeriesNetApi::Models::AssignmentCategory}

  context 'methods' do
    it 'should create an empty instance of AeriesNetApi::Models::AssignmentCategory' do
