...
describe AeriesNetApi::Models::FinalMark do

 let(:test_class) {AeriesNetApi::Models::FinalMark}

  context 'methods' do
    it 'should create an empty instance of AeriesNetApi::Models::FinalMark' do
