...
describe AeriesNetApi::Models::AssignmentStandard do

 let(:test_class) {AeriesNetApi::Models::AssignmentStandard}

  context 'methods' do
    it 'should create an empty instance of AeriesNetApi::Models::AssignmentStandard' do
