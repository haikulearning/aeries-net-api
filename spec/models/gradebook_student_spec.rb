...
describe AeriesNetApi::Models::GradebookStudent do

  let(:test_class) { AeriesNetApi::Models::GradebookStudent }

  context 'methods' do
    it 'should create an empty instance of AeriesNetApi::Models::GradebookStudent' do
