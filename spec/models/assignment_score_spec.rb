...
describe AeriesNetApi::Models::AssignmentScore do

 let(:test_class) {AeriesNetApi::Models::AssignmentScore}

  context 'methods' do
    it 'should create an empty instance of AeriesNetApi::Models::AssignmentScore' do
